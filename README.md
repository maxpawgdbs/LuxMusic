...
Обновления, подписанные тем же сертификатом, устанавливаются поверх предыдущей версии с сохранением локальной библиотеки. Для обновления до 0.7 не удаляйте приложение и не очищайте его данные. Подпись, пакет приложения и пути уже скачанной музыки сохранены.

Изменения и совместимость: [релиз 0.7](docs/release-0.7.md). Техническое описание и команды тестирования: [модуль загрузки](docs/download-module-rewrite.md).
...
- Тег `v0.7` создаёт отдельный стабильный GitHub Release.
