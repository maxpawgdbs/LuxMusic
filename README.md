...
### Системная MediaSession

- Встроенная интеграция Media3 с системной медиапанелью и экраном блокировки.
- Активная системная MediaSession и постоянное MediaStyle-уведомление с актуальными метаданными и состоянием.
- Кнопки паузы, продолжения, предыдущей и следующей песни.
- Перемотка через системный ползунок текущей позиции.
- Обложка, название песни, исполнитель и прогресс воспроизведения.
...
- Тег формата `v0.5.2` создаёт отдельный стабильный GitHub Release.
