...
val baseVersionName = providers.gradleProperty("luxmusic.baseVersion").orNull ?: "0.5.3"
val appVersionCode = System.getenv("LUXMUSIC_VERSION_CODE")?.toIntOrNull() ?: 500300
