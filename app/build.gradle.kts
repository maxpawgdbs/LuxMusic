...
val baseVersionName = providers.gradleProperty("luxmusic.baseVersion").orNull ?: "0.7.3"
val appVersionCode = System.getenv("LUXMUSIC_VERSION_CODE")?.toIntOrNull() ?: 7_003_000
