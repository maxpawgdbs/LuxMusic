...
val baseVersionName = providers.gradleProperty("luxmusic.baseVersion").orNull ?: "0.5.2"
val appVersionCode = System.getenv("LUXMUSIC_VERSION_CODE")?.toIntOrNull() ?: 500200
